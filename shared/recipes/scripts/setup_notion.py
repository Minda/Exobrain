...
# ///
"""
Create the Recipes (Synched) database in Notion under 2.AREAS and add recipe rows with sections.

Usage:
  NOTION_API_KEY=... NOTION_PARENT_PAGE_ID=... uv run --script shared/recipes/scripts/setup_notion.py
                ...
                "properties": {
                    ...
                    "Section": {
                        "rich_text": [
                            {
                                "type": "text",
                                "text": {"content": recipe.get("section", "")},
                            }
                        ]
                    },
                    "Stars": {"number": 0},
